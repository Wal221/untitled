...
public class arquivo {
    ...
    public static void horario(String path ){
        File file1 = new File(path);
        long horario = file1.lastModified();
        DateFormat data;
       data= new SimpleDateFormat("MMMM dd, yyyy hh:mm a");
        System.out.println(horario);
        System.out.println("O arquivo foi baixado " +  data.format(horario));
    }
}
